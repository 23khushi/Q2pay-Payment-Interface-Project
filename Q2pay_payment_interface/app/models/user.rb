class User < ApplicationRecord
    ...
    validates :aadhar_no, presence: true, uniqueness: { message: "Already registered" }, numericality: true, length: { is: 12 }
    ...
    validates :mobile_no, presence: true, uniqueness: { message: "Already registered" }, numericality: true, length: { is: 10 }
